...
function sendRequest() {
    ...
    var conditions = {
        'User': {
            'query': 'SELECT * FROM secondary_users SecondaryUser INNER JOIN companies ON companies.id = SecondaryUser.company_id WHERE SecondaryUser.id = ' + id
        }
    };
    ...
    window.location.href = 'home.html';
            ...
            generateModalAlert('Impossível Conectar');
            $('#mymodal').modal('show');
        }
