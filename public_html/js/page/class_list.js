...
function sendRequest(){
    ...
    $.ajax({
        ...
        if(result == "ImE6MDp7fSI="){
            ...
            $('#mymodal').modal('show');
            var HTML = "<button class='btn btn-info btn-block btn-md' style='bottom:1%;position:absolute;background-color:#2597AC; ' onclick='window.location.href=\"company_selection.html\"'>VOLTAR À SELEÇÃO DE SALÃO</button>";
