...
$(document).ready(function () {
    ...
    class_id = $.cookieStorage.get('subclasses').classe_id;
...
function Click(subclasse){
    $.cookieStorage.set(subclasse);
...
function sendRequest(){
    var query = "SELECT * FROM services INNER JOIN subclasses ON services.subclasse_id = subclasses.id WHERE services.companie_id = "+company_id + " and subclasses.classe_id = " + class_id;
    console.log(query);
    var conditions = {
        'General': {
            'query':query
    ...
    $.ajax({
        ...
        for(var n = 0; n<convertedReturn2.length;n++){
            ...
            var HTML = "<div id='service_class' class='tablecontent' onclick='Click("+objReturn1+")'>"+classe1.subclasses.name+"</div><div class='bottomLine1'></div>";

            if(classe1.subclasses.name!=g){
                $("#conteudo").append(HTML);
            }
            g='';
            g=classe1.subclasses.name;

        }
       // var tam = $(".tablecontent").length;
      //  for(var f = 0;f<tam;f++){
       //     g += ($(".tablecontent")[f].innerHTML);
       // }
       // for(var f = 0;f<tam;f++) {
        //    if (g.indexOf($(".tablecontent")[f].innerHTML)) {
         //       var id = ($(".tablecontent")[f].id);
        //        console.log($(".tablecontent")[f].innerHTML);
        //        $("#"+id).removeClass("hide");
       //     }
       // }
