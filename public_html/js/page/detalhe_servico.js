$(document).ready(function () {
    $("#service_photoimg").attr('src', 'https://'+ip+'/jezzy-mobile-professionals/public_html/img/icons/loading.gif');
...
function sendRequest(){
    ...
    $.ajax({
        ...
        for(var n = 0; n<convertedReturn.length;n++){
            ...
            var urlp = 'https://'+api+'/General/get/query/' + createToken();
                ...
                for(var i=0;i<convertedReturnp.length;i++){
                   var service = convertedReturnp[i];
                    if(service.classes.classes_photo!= ""&&service.classes.classes_photo!= null){
                        ...
                        if($.cookieStorage.get('SecondaryUser').gender == 'male'){
